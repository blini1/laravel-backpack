...
class ReviewCrudController extends CrudController
{
    ...
    {
        CRUD::column('body');
        CRUD::column('reviewable_id');
        CRUD::column('reviewable_type');
    }
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('body');
        CRUD::field('reviewable')
            ->label('For')
            ->addMorphOption('App\Models\Car', 'Car', ['attribute' => 'make'])
            ->addMorphOption('App\Models\Owner', 'Owner', ['attribute' => 'name']);
    }
